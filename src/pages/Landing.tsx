      ...
      <Batanga />
        <div className="max-w-md">
          ...
          <div className="flex gap-4 justify-center items-center">
            <Link to="/play">
              <button className="btn btn-neutral"><BiSolidDrink/>Freeplay</button>
            </Link>
              <button className="flex flex-row btn glass cursor-not-allowed tooltip" data-tip="Coming soon"><LuSwords/><span>Tournament Mode</span></button>
          </div>
        </div>
      </div>
    </div>
